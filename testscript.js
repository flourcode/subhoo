...
// --- Share Button Listener with Null Check ---
        ...
        if (shareButton) { // <-- ADD THIS LINE: Check if the button exists
            shareButton.addEventListener('click', async () => {
                const shareData = {
                    title: document.title,
                    text: 'Check out Subhoo - Federal Subcontractor Intelligence!',
                ...
                if (navigator.share) {
                    ...
                    // Fallback copy logic could go here if desired
                }
            });
        } else { // <-- OPTIONAL: Add this else block for debugging
             console.warn('Share button element (#share-button) not found when attaching listener.'); // Log if button missing
        }
...
// Use the full defined list (or apply file existence logic here if needed)
