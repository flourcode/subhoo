...
let currentAgency = 'nasa'; // Your default agency
...
//     console.log("Discovering agencies (assuming all files exist)...");
    ...
    const agencies = [
        ...
        { value: 'army', label: 'US Army' },
        { value: 'navy', label: 'US Navy' },
        { value: 'airforce', label: 'US Air Force' },
        { value: 'socom', label: 'USSOCOM' },
        { value: 'dhs', label: 'DHS' },
        { value: 'cbp', label: 'CBP' },
        { value: 'uscc', label: 'US Cyber Command' },
    ...
    if (availableAgencies.length > 0) {
        ...
        // Determine initial agency based on the global variable 'currentAgency' ('nasa')
        // Since we assume 'nasa' exists, this should always select 'nasa' now.
...
//         console.log(`Found ${allExpiringContracts.length} potentially expiring contracts > ${formatCurrency(expiringAmountThreshold)}.`);
